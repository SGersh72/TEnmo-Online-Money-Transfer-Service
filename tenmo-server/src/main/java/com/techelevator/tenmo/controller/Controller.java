...
//USE THIS ENDPOINT FOR EASE OF USE
...
//WE DON'T NEED AN ACCOUNT ID FOR THIS TO WORK
    @ResponseStatus(HttpStatus.OK)
...
//HOW MUCH WORK IS REASONABLE IN THE CONTROLLER: SHOULD WE UPDATE BOTH ACCOUNTS IN THE CLIENT SIDE OR UPDATE BOTH IN THE CONTROLLER
//REDUCES RISKS OF MISTAKES ON CLIENT SIDE?
//IS THAT SOMETHING WE SHOULD DO IN THE SERVER SIDE SERVICE CLASS?
}
