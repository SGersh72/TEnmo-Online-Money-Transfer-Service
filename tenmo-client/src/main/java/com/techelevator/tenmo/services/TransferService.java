...
import com.techelevator.tenmo.validation.InputValidation;
    ...
    public void transferRequestProcessResponse(Transfer transfer){
        switch(Math.toIntExact(transfer.getTransferStatusId())) {
            ...
            case (int)APPROVED:
                ...
                //System.out.println("Your balance is " + accountService.getAccountByAccountId(transfer.getAccountFrom()).getBalance());
                break;
